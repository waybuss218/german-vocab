...
function loadState(){try{const x={...blank(),...JSON.parse(localStorage.getItem(STORE))}; x.modules=x.modules||{};x.history=x.history||[];x.unknown=x.unknown||[];x.module_work=x.module_work||{};x.error_reports=x.error_reports||{};return migrateState(x)}catch{return blank()}}
